...
public class TestSimpleFileCopyListing {
  private static final Log LOG = LogFactory.getLog(TestSimpleFileCopyListing.class);
  ...
  private void runTest(Path listFile, Path target, boolean sync) throws IOException {
    CopyListing listing = new SimpleFileBasedCopyListing(config, CREDENTIALS);
